...
//                 TextBox* timeBox;
//                 timeBox = new TextBox(60,y,260,20, "Flight Time: " +
//                 to_string(temp->weight)+ "hours"); timeBox
//                 ->color(FL_DARK_BLUE); timeBox ->box(FL_FLAT_BOX);
//                 results->add(timeBox);
//                 y+= 25;
//                 stops ++;
//             }
...
//         TextBox* stopBox;
//         stopBox = new TextBox(40, y +10, 300,25, "Total Stops: " +
//         to_string(stops)); stopBox->labelfont(Fl_Font(FL_BOLD));
